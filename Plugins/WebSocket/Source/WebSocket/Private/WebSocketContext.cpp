...
//	UWebSocketBase* pWebSocketBase = (UWebSocketBase*)pUser;
    UWebSocketBase* pWebSocketBase = static_cast<UWebSocketBase*>(pUser);
	...
	case LWS_CALLBACK_CLOSED:
        ...
        pWebSocketBase->ProcessWebSocketEvent(EWS_State::closed, (const char*)in,len);
	...
	case LWS_CALLBACK_CLIENT_CONNECTION_ERROR:
	{
        ...
        pWebSocketBase->ProcessWebSocketEvent(EWS_State::error, (const char*)in, len);
	}
		break;
	...
	case LWS_CALLBACK_CLIENT_ESTABLISHED:
        ...
        pWebSocketBase->ProcessWebSocketEvent(EWS_State::connectComplete, (const char*)in, len);
		break;
...
UWebSocketBase* UWebSocketContext::Connect(const FString& uri, const TMap<FString, FString>& header)
{
    ...
    if (pNewSocketBase->Connect(uri, header))
    {
