...
UChatMember *UChatMember::ChatMemberInstance = nullptr;
...
UChatMember * UChatMember::GetChatMemberInstance()
{
	if (ChatMemberInstance==nullptr)
	{
		ChatMemberInstance = NewObject<UChatMember>();
		ChatMemberInstance->AddToRoot();
	}
	return ChatMemberInstance;
}
...
/***************** Base **************************/
UChat *UChat::ChatInstance = nullptr;
...
UChat * UChat::GetUChat()
{
	return  UChat *instance =NewObject<UChat>();
	instance->AddToRoot();
	return instance;
