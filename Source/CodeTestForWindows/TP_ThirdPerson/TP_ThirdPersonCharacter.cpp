...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	//MeshTest
	//ConstructorHelpers helps;
	
	/*const ConstructorHelpers::FObjectFinder<UStaticMesh> ObjectAsset=const ConstructorHelpers::FObjectFinder<UStaticMesh>(TEXT("/Game/StarterContent/Shapes/Shape_Sphere.Shape_Sphere"));
	static ConstructorHelpers::FObjectFinder<UStaticMesh>asetrret(TEXT("/Game/StarterContent/Shapes/Shape_Sphere.Shape_Sphere"));
	*/
	// MeshTestAsset
